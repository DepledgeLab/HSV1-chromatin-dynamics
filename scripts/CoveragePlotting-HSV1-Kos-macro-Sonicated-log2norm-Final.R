...
file1 <- fread('./DepthBeds/LS13.HSV1-Kos-X1000.Filtered.sorted.paired.depth.fixed.bed', col.names = c('chromosome', 'pos', 'value'))
file2 <- fread('./DepthBeds/LS14.HSV1-Kos-X1000.Filtered.sorted.paired.depth.fixed.bed', col.names = c('chromosome', 'pos', 'value'))
file3 <- fread('./DepthBeds/LS15.HSV1-Kos-X1000.Filtered.sorted.paired.depth.fixed.bed', col.names = c('chromosome', 'pos', 'value'))
file4 <- fread('./DepthBeds/LS16.HSV1-Kos-X1000.Filtered.sorted.paired.depth.fixed.bed', col.names = c('chromosome', 'pos', 'value'))

file5 <- fread('./DepthBeds/LS77.HSV1-Kos-X1000.Filtered.sorted.paired.depth.fixed.bed', col.names = c('chromosome', 'pos', 'value'))
file6 <- fread('./DepthBeds/LS78.HSV1-Kos-X1000.Filtered.sorted.paired.depth.fixed.bed', col.names = c('chromosome', 'pos', 'value'))
file7 <- fread('./DepthBeds/LS79.HSV1-Kos-X1000.Filtered.sorted.paired.depth.fixed.bed', col.names = c('chromosome', 'pos', 'value'))
file8 <- fread('./DepthBeds/LS80.HSV1-Kos-X1000.Filtered.sorted.paired.depth.fixed.bed', col.names = c('chromosome', 'pos', 'value'))

file9 <- fread('./DepthBeds/LS45.HSV1-Kos-X1000.Filtered.sorted.paired.depth.fixed.bed', col.names = c('chromosome', 'pos', 'value'))
file10 <- fread('./DepthBeds/LS46.HSV1-Kos-X1000.Filtered.sorted.paired.depth.fixed.bed', col.names = c('chromosome', 'pos', 'value'))
file11 <- fread('./DepthBeds/LS47.HSV1-Kos-X1000.Filtered.sorted.paired.depth.fixed.bed', col.names = c('chromosome', 'pos', 'value'))
file12 <- fread('./DepthBeds/LS48.HSV1-Kos-X1000.Filtered.sorted.paired.depth.fixed.bed', col.names = c('chromosome', 'pos', 'value'))

file13 <- fread('./DepthBeds/LS61.HSV1-Kos-X1000.Filtered.sorted.paired.depth.fixed.bed', col.names = c('chromosome', 'pos', 'value'))
file14 <- fread('./DepthBeds/LS62.HSV1-Kos-X1000.Filtered.sorted.paired.depth.fixed.bed', col.names = c('chromosome', 'pos', 'value'))
file15 <- fread('./DepthBeds/LS63.HSV1-Kos-X1000.Filtered.sorted.paired.depth.fixed.bed', col.names = c('chromosome', 'pos', 'value'))
file16 <- fread('./DepthBeds/LS64.HSV1-Kos-X1000.Filtered.sorted.paired.depth.fixed.bed', col.names = c('chromosome', 'pos', 'value'))
...
### FLAG bioreps
#pdf(file = "macro-FlagBioreps.pdf", width = 10, height = 5)
...
### H2B bioreps
#pdf(file = "macro-H2BBioreps.pdf", width = 10, height = 5)
...
### Biorep #1
#pdf(file = "macro-Flag&H2B-Biorep1.pdf", width = 10, height = 5)
...
### Biorep #2
pdf(file = "macro-Flag&H2B-Biorep2.pdf", width = 10, height = 5)
...
### GENERATE FINAL PLOT
pdf(file = "macro-Final-Biorep1.pdf", width = 10, height = 5)
...
pdf(file = "macro-Final-Biorep2.pdf", width = 10, height = 5)
...
pdf(file = "macro-Final-BothBioReps.pdf", width = 10, height = 5)
