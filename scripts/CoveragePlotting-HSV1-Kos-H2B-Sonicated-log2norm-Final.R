...
file1 <- fread('./DepthBeds/LS9.HSV1-Kos-X1000.Filtered.sorted.paired.depth.fixed.bed', col.names = c('chromosome', 'pos', 'value'))
file2 <- fread('./DepthBeds/LS10.HSV1-Kos-X1000.Filtered.sorted.paired.depth.fixed.bed', col.names = c('chromosome', 'pos', 'value'))
file3 <- fread('./DepthBeds/LS11.HSV1-Kos-X1000.Filtered.sorted.paired.depth.fixed.bed', col.names = c('chromosome', 'pos', 'value'))
file4 <- fread('./DepthBeds/LS12.HSV1-Kos-X1000.Filtered.sorted.paired.depth.fixed.bed', col.names = c('chromosome', 'pos', 'value'))

file5 <- fread('./DepthBeds/LS73.HSV1-Kos-X1000.Filtered.sorted.paired.depth.fixed.bed', col.names = c('chromosome', 'pos', 'value'))
file6 <- fread('./DepthBeds/LS74.HSV1-Kos-X1000.Filtered.sorted.paired.depth.fixed.bed', col.names = c('chromosome', 'pos', 'value'))
file7 <- fread('./DepthBeds/LS75.HSV1-Kos-X1000.Filtered.sorted.paired.depth.fixed.bed', col.names = c('chromosome', 'pos', 'value'))
file8 <- fread('./DepthBeds/LS76.HSV1-Kos-X1000.Filtered.sorted.paired.depth.fixed.bed', col.names = c('chromosome', 'pos', 'value'))

file9 <- fread('./DepthBeds/LS41.HSV1-Kos-X1000.Filtered.sorted.paired.depth.fixed.bed', col.names = c('chromosome', 'pos', 'value'))
file10 <- fread('./DepthBeds/LS42.HSV1-Kos-X1000.Filtered.sorted.paired.depth.fixed.bed', col.names = c('chromosome', 'pos', 'value'))
file11 <- fread('./DepthBeds/LS43.HSV1-Kos-X1000.Filtered.sorted.paired.depth.fixed.bed', col.names = c('chromosome', 'pos', 'value'))
file12 <- fread('./DepthBeds/LS44.HSV1-Kos-X1000.Filtered.sorted.paired.depth.fixed.bed', col.names = c('chromosome', 'pos', 'value'))

file13 <- fread('./DepthBeds/LS57.HSV1-Kos-X1000.Filtered.sorted.paired.depth.fixed.bed', col.names = c('chromosome', 'pos', 'value'))
file14 <- fread('./DepthBeds/LS58.HSV1-Kos-X1000.Filtered.sorted.paired.depth.fixed.bed', col.names = c('chromosome', 'pos', 'value'))
file15 <- fread('./DepthBeds/LS59.HSV1-Kos-X1000.Filtered.sorted.paired.depth.fixed.bed', col.names = c('chromosome', 'pos', 'value'))
file16 <- fread('./DepthBeds/LS60.HSV1-Kos-X1000.Filtered.sorted.paired.depth.fixed.bed', col.names = c('chromosome', 'pos', 'value'))
...
### FLAG bioreps
#pdf(file = "H2B-FlagBioreps.pdf", width = 10, height = 5)
...
### H2B bioreps
#pdf(file = "H2B-H2BBioreps.pdf", width = 10, height = 5)
...
### Biorep #1
#pdf(file = "H2B-Flag&H2B-Biorep1.pdf", width = 10, height = 5)
...
### Biorep #2
pdf(file = "H2B-Flag&H2B-Biorep2.pdf", width = 10, height = 5)
...
### GENERATE FINAL PLOT
pdf(file = "H2B-Final-Biorep1.pdf", width = 10, height = 5)
...
pdf(file = "H2B-Final-Biorep2.pdf", width = 10, height = 5)
...
pdf(file = "H2B-Final-BothBioReps.pdf", width = 10, height = 5)
