...
#BIOREP1
file1 <- fread('../DepthBeds/LS81.HSV1-Kos-X1000.Filtered.12k.sorted.paired.depth.fixed.bed', col.names = c('chromosome', 'pos', 'value'))
file2 <- fread('../DepthBeds/LS82.HSV1-Kos-X1000.Filtered.12k.sorted.paired.depth.fixed.bed', col.names = c('chromosome', 'pos', 'value'))
file3 <- fread('../DepthBeds/LS83.HSV1-Kos-X1000.Filtered.12k.sorted.paired.depth.fixed.bed', col.names = c('chromosome', 'pos', 'value'))
file4 <- fread('../DepthBeds/LS84.HSV1-Kos-X1000.Filtered.sorted.paired.depth.fixed.bed', col.names = c('chromosome', 'pos', 'value'))
file5 <- fread('../DepthBeds/LS85.HSV1-Kos-X1000.Filtered.sorted.paired.depth.fixed.bed', col.names = c('chromosome', 'pos', 'value'))
file6 <- fread('../DepthBeds/LS86.HSV1-Kos-X1000.Filtered.sorted.paired.depth.fixed.bed', col.names = c('chromosome', 'pos', 'value'))
file7 <- fread('../DepthBeds/LS87.HSV1-Kos-X1000.Filtered.sorted.paired.depth.fixed.bed', col.names = c('chromosome', 'pos', 'value'))
file8 <- fread('../DepthBeds/LS88.HSV1-Kos-X1000.Filtered.sorted.paired.depth.fixed.bed', col.names = c('chromosome', 'pos', 'value'))
file9 <- fread('../DepthBeds/LS89.HSV1-Kos-X1000.Filtered.sorted.paired.depth.fixed.bed', col.names = c('chromosome', 'pos', 'value'))
file10 <- fread('../DepthBeds/LS90.HSV1-Kos-X1000.Filtered.sorted.paired.depth.fixed.bed', col.names = c('chromosome', 'pos', 'value'))
file11 <- fread('../DepthBeds/LS91.HSV1-Kos-X1000.Filtered.sorted.paired.depth.fixed.bed', col.names = c('chromosome', 'pos', 'value'))
file12 <- fread('../DepthBeds/LS92.HSV1-Kos-X1000.Filtered.sorted.paired.depth.fixed.bed', col.names = c('chromosome', 'pos', 'value'))
#BIOREP2
file13 <- fread('../DepthBeds/LS129.HSV1-Kos-X1000.Filtered.12k.sorted.paired.depth.fixed.bed', col.names = c('chromosome', 'pos', 'value'))
file14 <- fread('../DepthBeds/LS130.HSV1-Kos-X1000.Filtered.12k.sorted.paired.depth.fixed.bed', col.names = c('chromosome', 'pos', 'value'))
file15 <- fread('../DepthBeds/LS131.HSV1-Kos-X1000.Filtered.12k.sorted.paired.depth.fixed.bed', col.names = c('chromosome', 'pos', 'value'))
file16 <- fread('../DepthBeds/LS132.HSV1-Kos-X1000.Filtered.sorted.paired.depth.fixed.bed', col.names = c('chromosome', 'pos', 'value'))
file17 <- fread('../DepthBeds/LS133.HSV1-Kos-X1000.Filtered.sorted.paired.depth.fixed.bed', col.names = c('chromosome', 'pos', 'value'))
file18 <- fread('../DepthBeds/LS134.HSV1-Kos-X1000.Filtered.sorted.paired.depth.fixed.bed', col.names = c('chromosome', 'pos', 'value'))
file19 <- fread('../DepthBeds/LS135.HSV1-Kos-X1000.Filtered.sorted.paired.depth.fixed.bed', col.names = c('chromosome', 'pos', 'value'))
file20 <- fread('../DepthBeds/LS136.HSV1-Kos-X1000.Filtered.sorted.paired.depth.fixed.bed', col.names = c('chromosome', 'pos', 'value'))
file21 <- fread('../DepthBeds/LS137.HSV1-Kos-X1000.Filtered.sorted.paired.depth.fixed.bed', col.names = c('chromosome', 'pos', 'value'))
file22 <- fread('../DepthBeds/LS138.HSV1-Kos-X1000.Filtered.sorted.paired.depth.fixed.bed', col.names = c('chromosome', 'pos', 'value'))
file23 <- fread('../DepthBeds/LS139.HSV1-Kos-X1000.Filtered.sorted.paired.depth.fixed.bed', col.names = c('chromosome', 'pos', 'value'))
file24 <- fread('../DepthBeds/LS140.HSV1-Kos-X1000.Filtered.sorted.paired.depth.fixed.bed', col.names = c('chromosome', 'pos', 'value'))
...
### INPUT bioreps
pdf(file = "H2AB-INPUT-Bioreps.pdf", width = 10, height = 5)
...
dev.off()
### LONG bioreps
pdf(file = "H2AB-LONG-Bioreps.pdf", width = 10, height = 5)
...
dev.off()
### PELLET bioreps
pdf(file = "H2AB-PELLET-Bioreps.pdf", width = 10, height = 5)
...
dev.off()
### SHORT bioreps
pdf(file = "H2AB-SHORT-Bioreps.pdf", width = 10, height = 5)
...
### GENERATE FINAL PLOT
pdf(file = "H2AB-Digestion-Biorep1.pdf", width = 10, height = 5)
...
pdf(file = "H2AB-Digestion-Biorep2.pdf", width = 10, height = 5)
...
pdf(file = "H2AB-Digestion-BothBioReps.pdf", width = 10, height = 5)
