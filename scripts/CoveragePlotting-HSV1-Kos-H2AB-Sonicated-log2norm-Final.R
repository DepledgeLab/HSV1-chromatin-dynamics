...
file1 <- fread('./DepthBeds/LS1.HSV1-Kos-X1000.Filtered.sorted.paired.depth.fixed.bed', col.names = c('chromosome', 'pos', 'value'))
file2 <- fread('./DepthBeds/LS2.HSV1-Kos-X1000.Filtered.sorted.paired.depth.fixed.bed', col.names = c('chromosome', 'pos', 'value'))
file3 <- fread('./DepthBeds/LS3.HSV1-Kos-X1000.Filtered.sorted.paired.depth.fixed.bed', col.names = c('chromosome', 'pos', 'value'))
file4 <- fread('./DepthBeds/LS4.HSV1-Kos-X1000.Filtered.sorted.paired.depth.fixed.bed', col.names = c('chromosome', 'pos', 'value'))

file5 <- fread('./DepthBeds/LS65.HSV1-Kos-X1000.Filtered.sorted.paired.depth.fixed.bed', col.names = c('chromosome', 'pos', 'value'))
file6 <- fread('./DepthBeds/LS66.HSV1-Kos-X1000.Filtered.sorted.paired.depth.fixed.bed', col.names = c('chromosome', 'pos', 'value'))
file7 <- fread('./DepthBeds/LS67.HSV1-Kos-X1000.Filtered.sorted.paired.depth.fixed.bed', col.names = c('chromosome', 'pos', 'value'))
file8 <- fread('./DepthBeds/LS68.HSV1-Kos-X1000.Filtered.sorted.paired.depth.fixed.bed', col.names = c('chromosome', 'pos', 'value'))

file9 <- fread('./DepthBeds/LS33.HSV1-Kos-X1000.Filtered.sorted.paired.depth.fixed.bed', col.names = c('chromosome', 'pos', 'value'))
file10 <- fread('./DepthBeds/LS34.HSV1-Kos-X1000.Filtered.sorted.paired.depth.fixed.bed', col.names = c('chromosome', 'pos', 'value'))
file11 <- fread('./DepthBeds/LS35.HSV1-Kos-X1000.Filtered.sorted.paired.depth.fixed.bed', col.names = c('chromosome', 'pos', 'value'))
file12 <- fread('./DepthBeds/LS36.HSV1-Kos-X1000.Filtered.sorted.paired.depth.fixed.bed', col.names = c('chromosome', 'pos', 'value'))

file13 <- fread('./DepthBeds/LS49.HSV1-Kos-X1000.Filtered.sorted.paired.depth.fixed.bed', col.names = c('chromosome', 'pos', 'value'))
file14 <- fread('./DepthBeds/LS50.HSV1-Kos-X1000.Filtered.sorted.paired.depth.fixed.bed', col.names = c('chromosome', 'pos', 'value'))
file15 <- fread('./DepthBeds/LS51.HSV1-Kos-X1000.Filtered.sorted.paired.depth.fixed.bed', col.names = c('chromosome', 'pos', 'value'))
file16 <- fread('./DepthBeds/LS52.HSV1-Kos-X1000.Filtered.sorted.paired.depth.fixed.bed', col.names = c('chromosome', 'pos', 'value'))
...
dataTrack1 <- DataTrack(range = FLAG_rep1_final, type = "l", chromosome=myChr, baseline = c(-1,0,1), col.baseline = c('black'), lty.baseline = c(2,1,2), genome = 'HSV1', fill = "#FFBE6A", col = "#FFBE6A", options(ucscChromosomeNames=FALSE),col.axis="black", background.title = "transparent", ylim=c(-4,4))
dataTrack2 <- DataTrack(range = FLAG_rep2_final, type = "l", chromosome=myChr, baseline = c(-1,0,1), col.baseline = c('black'), lty.baseline = c(2,1,2), genome = 'HSV1', fill = "#FFBE6A", col = "#FFBE6A", options(ucscChromosomeNames=FALSE),col.axis="black", background.title = "transparent", ylim=c(-4,4))
dataTrack3 <- DataTrack(range = FLAG_rep1_chx_final, type = "l", chromosome=myChr, baseline = c(-1,0,1), col.baseline = c('black'), lty.baseline = c(2,1,2), genome = 'HSV1', fill = "#40B0A6", col = "#40B0A6", options(ucscChromosomeNames=FALSE),col.axis="black", background.title = "transparent", ylim=c(-4,4))
dataTrack4 <- DataTrack(range = FLAG_rep2_chx_final, type = "l", chromosome=myChr, baseline = c(-1,0,1), col.baseline = c('black'), lty.baseline = c(2,1,2), genome = 'HSV1', fill = "#40B0A6", col = "#40B0A6", options(ucscChromosomeNames=FALSE),col.axis="black", background.title = "transparent", ylim=c(-4,4))
dataTrack5 <- DataTrack(range = H2B_rep1_final, type = "l", chromosome=myChr, baseline = c(-1,0,1), col.baseline = c('black'), lty.baseline = c(2,1,2), genome = 'HSV1', fill = "#1AFF1A", col = "#1AFF1A", options(ucscChromosomeNames=FALSE),col.axis="black", background.title = "transparent", ylim=c(-4,4))
dataTrack6 <- DataTrack(range = H2B_rep2_final, type = "l", chromosome=myChr, baseline = c(-1,0,1), col.baseline = c('black'), lty.baseline = c(2,1,2), genome = 'HSV1', fill = "#1AFF1A", col = "#1AFF1A", options(ucscChromosomeNames=FALSE),col.axis="black", background.title = "transparent", ylim=c(-4,4))
dataTrack7 <- DataTrack(range = H2B_rep1_chx_final, type = "l", chromosome=myChr, baseline = c(-1,0,1), col.baseline = c('black'), lty.baseline = c(2,1,2), genome = 'HSV1', fill = "#4B0092", col = "#4B0092", options(ucscChromosomeNames=FALSE),col.axis="black", background.title = "transparent", ylim=c(-4,4))
dataTrack8 <- DataTrack(range = H2B_rep2_chx_final, type = "l", chromosome=myChr, baseline = c(-1,0,1), col.baseline = c('black'), lty.baseline = c(2,1,2), genome = 'HSV1', fill = "#4B0092", col = "#4B0092", options(ucscChromosomeNames=FALSE),col.axis="black", background.title = "transparent", ylim=c(-4,4))


### INTERMEDIATE PLOTTING

### FLAG bioreps
#pdf(file = "H2AB-FlagBioreps.pdf", width = 10, height = 5)
...
### H2B bioreps
#pdf(file = "H2AB-H2BBioreps.pdf", width = 10, height = 5)
...
### Biorep #1
#pdf(file = "H2AB-Flag&H2B-Biorep1.pdf", width = 10, height = 5)
...
### Biorep #2
pdf(file = "H2AB-Flag&H2B-Biorep2.pdf", width = 10, height = 5)
...
### GENERATE FINAL PLOT
pdf(file = "H2AB-Final-Biorep1.pdf", width = 10, height = 5)
...
pdf(file = "H2AB-Final-Biorep2.pdf", width = 10, height = 5)
...
pdf(file = "H2AB-Final-BothBioReps.pdf", width = 10, height = 5)
