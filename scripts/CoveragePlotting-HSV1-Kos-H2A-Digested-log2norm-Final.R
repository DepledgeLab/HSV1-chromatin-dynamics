...
#BIOREP1
file1 <- fread('../DepthBeds/LS93.HSV1-Kos-X1000.Filtered.12k.sorted.paired.depth.fixed.bed', col.names = c('chromosome', 'pos', 'value'))
file2 <- fread('../DepthBeds/LS94.HSV1-Kos-X1000.Filtered.12k.sorted.paired.depth.fixed.bed', col.names = c('chromosome', 'pos', 'value'))
file3 <- fread('../DepthBeds/LS95.HSV1-Kos-X1000.Filtered.12k.sorted.paired.depth.fixed.bed', col.names = c('chromosome', 'pos', 'value'))
file4 <- fread('../DepthBeds/LS96.HSV1-Kos-X1000.Filtered.sorted.paired.depth.fixed.bed', col.names = c('chromosome', 'pos', 'value'))
file5 <- fread('../DepthBeds/LS97.HSV1-Kos-X1000.Filtered.sorted.paired.depth.fixed.bed', col.names = c('chromosome', 'pos', 'value'))
file6 <- fread('../DepthBeds/LS98.HSV1-Kos-X1000.Filtered.sorted.paired.depth.fixed.bed', col.names = c('chromosome', 'pos', 'value'))
file7 <- fread('../DepthBeds/LS99.HSV1-Kos-X1000.Filtered.sorted.paired.depth.fixed.bed', col.names = c('chromosome', 'pos', 'value'))
file8 <- fread('../DepthBeds/LS100.HSV1-Kos-X1000.Filtered.sorted.paired.depth.fixed.bed', col.names = c('chromosome', 'pos', 'value'))
file9 <- fread('../DepthBeds/LS101.HSV1-Kos-X1000.Filtered.sorted.paired.depth.fixed.bed', col.names = c('chromosome', 'pos', 'value'))
file10 <- fread('../DepthBeds/LS102.HSV1-Kos-X1000.Filtered.sorted.paired.depth.fixed.bed', col.names = c('chromosome', 'pos', 'value'))
file11 <- fread('../DepthBeds/LS103.HSV1-Kos-X1000.Filtered.sorted.paired.depth.fixed.bed', col.names = c('chromosome', 'pos', 'value'))
file12 <- fread('../DepthBeds/LS104.HSV1-Kos-X1000.Filtered.sorted.paired.depth.fixed.bed', col.names = c('chromosome', 'pos', 'value'))
#BIOREP2
file13 <- fread('../DepthBeds/LS141.HSV1-Kos-X1000.Filtered.12k.sorted.paired.depth.fixed.bed', col.names = c('chromosome', 'pos', 'value'))
file14 <- fread('../DepthBeds/LS142.HSV1-Kos-X1000.Filtered.12k.sorted.paired.depth.fixed.bed', col.names = c('chromosome', 'pos', 'value'))
file15 <- fread('../DepthBeds/LS143.HSV1-Kos-X1000.Filtered.12k.sorted.paired.depth.fixed.bed', col.names = c('chromosome', 'pos', 'value'))
file16 <- fread('../DepthBeds/LS144.HSV1-Kos-X1000.Filtered.sorted.paired.depth.fixed.bed', col.names = c('chromosome', 'pos', 'value'))
file17 <- fread('../DepthBeds/LS145.HSV1-Kos-X1000.Filtered.sorted.paired.depth.fixed.bed', col.names = c('chromosome', 'pos', 'value'))
file18 <- fread('../DepthBeds/LS146.HSV1-Kos-X1000.Filtered.sorted.paired.depth.fixed.bed', col.names = c('chromosome', 'pos', 'value'))
file19 <- fread('../DepthBeds/LS147.HSV1-Kos-X1000.Filtered.sorted.paired.depth.fixed.bed', col.names = c('chromosome', 'pos', 'value'))
file20 <- fread('../DepthBeds/LS148.HSV1-Kos-X1000.Filtered.sorted.paired.depth.fixed.bed', col.names = c('chromosome', 'pos', 'value'))
file21 <- fread('../DepthBeds/LS149.HSV1-Kos-X1000.Filtered.sorted.paired.depth.fixed.bed', col.names = c('chromosome', 'pos', 'value'))
file22 <- fread('../DepthBeds/LS150.HSV1-Kos-X1000.Filtered.sorted.paired.depth.fixed.bed', col.names = c('chromosome', 'pos', 'value'))
file23 <- fread('../DepthBeds/LS151.HSV1-Kos-X1000.Filtered.sorted.paired.depth.fixed.bed', col.names = c('chromosome', 'pos', 'value'))
file24 <- fread('../DepthBeds/LS152.HSV1-Kos-X1000.Filtered.sorted.paired.depth.fixed.bed', col.names = c('chromosome', 'pos', 'value'))
...
### INPUT bioreps
pdf(file = "H2A-INPUT-Bioreps.pdf", width = 10, height = 5)
...
dev.off()
### LONG bioreps
pdf(file = "H2A-LONG-Bioreps.pdf", width = 10, height = 5)
...
dev.off()
### PELLET bioreps
pdf(file = "H2A-PELLET-Bioreps.pdf", width = 10, height = 5)
...
dev.off()
### SHORT bioreps
pdf(file = "H2A-SHORT-Bioreps.pdf", width = 10, height = 5)
...
### GENERATE FINAL PLOT
pdf(file = "H2A-Digestion-Biorep1.pdf", width = 10, height = 5)
...
pdf(file = "H2A-Digestion-Biorep2.pdf", width = 10, height = 5)
...
pdf(file = "H2A-Digestion-BothBioReps.pdf", width = 10, height = 5)
