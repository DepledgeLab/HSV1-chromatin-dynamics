...
#BIOREP1
file1 <- fread('../DepthBeds/LS117.HSV1-Kos-X1000.Filtered.12k.sorted.paired.depth.fixed.bed', col.names = c('chromosome', 'pos', 'value'))
file2 <- fread('../DepthBeds/LS118.HSV1-Kos-X1000.Filtered.12k.sorted.paired.depth.fixed.bed', col.names = c('chromosome', 'pos', 'value'))
file3 <- fread('../DepthBeds/LS119.HSV1-Kos-X1000.Filtered.12k.sorted.paired.depth.fixed.bed', col.names = c('chromosome', 'pos', 'value'))
file4 <- fread('../DepthBeds/LS120.HSV1-Kos-X1000.Filtered.sorted.paired.depth.fixed.bed', col.names = c('chromosome', 'pos', 'value'))
file5 <- fread('../DepthBeds/LS121.HSV1-Kos-X1000.Filtered.sorted.paired.depth.fixed.bed', col.names = c('chromosome', 'pos', 'value'))
file6 <- fread('../DepthBeds/LS122.HSV1-Kos-X1000.Filtered.sorted.paired.depth.fixed.bed', col.names = c('chromosome', 'pos', 'value'))
file7 <- fread('../DepthBeds/LS123.HSV1-Kos-X1000.Filtered.sorted.paired.depth.fixed.bed', col.names = c('chromosome', 'pos', 'value'))
file8 <- fread('../DepthBeds/LS124.HSV1-Kos-X1000.Filtered.sorted.paired.depth.fixed.bed', col.names = c('chromosome', 'pos', 'value'))
file9 <- fread('../DepthBeds/LS125.HSV1-Kos-X1000.Filtered.sorted.paired.depth.fixed.bed', col.names = c('chromosome', 'pos', 'value'))
file10 <- fread('../DepthBeds/LS126.HSV1-Kos-X1000.Filtered.sorted.paired.depth.fixed.bed', col.names = c('chromosome', 'pos', 'value'))
file11 <- fread('../DepthBeds/LS127.HSV1-Kos-X1000.Filtered.sorted.paired.depth.fixed.bed', col.names = c('chromosome', 'pos', 'value'))
file12 <- fread('../DepthBeds/LS128.HSV1-Kos-X1000.Filtered.sorted.paired.depth.fixed.bed', col.names = c('chromosome', 'pos', 'value'))
#BIOREP2
file13 <- fread('../DepthBeds/LS165.HSV1-Kos-X1000.Filtered.12k.sorted.paired.depth.fixed.bed', col.names = c('chromosome', 'pos', 'value'))
file14 <- fread('../DepthBeds/LS166.HSV1-Kos-X1000.Filtered.12k.sorted.paired.depth.fixed.bed', col.names = c('chromosome', 'pos', 'value'))
file15 <- fread('../DepthBeds/LS167.HSV1-Kos-X1000.Filtered.12k.sorted.paired.depth.fixed.bed', col.names = c('chromosome', 'pos', 'value'))
file16 <- fread('../DepthBeds/LS168.HSV1-Kos-X1000.Filtered.sorted.paired.depth.fixed.bed', col.names = c('chromosome', 'pos', 'value'))
file17 <- fread('../DepthBeds/LS169.HSV1-Kos-X1000.Filtered.sorted.paired.depth.fixed.bed', col.names = c('chromosome', 'pos', 'value'))
file18 <- fread('../DepthBeds/LS170.HSV1-Kos-X1000.Filtered.sorted.paired.depth.fixed.bed', col.names = c('chromosome', 'pos', 'value'))
file19 <- fread('../DepthBeds/LS171.HSV1-Kos-X1000.Filtered.sorted.paired.depth.fixed.bed', col.names = c('chromosome', 'pos', 'value'))
file20 <- fread('../DepthBeds/LS172.HSV1-Kos-X1000.Filtered.sorted.paired.depth.fixed.bed', col.names = c('chromosome', 'pos', 'value'))
file21 <- fread('../DepthBeds/LS173.HSV1-Kos-X1000.Filtered.sorted.paired.depth.fixed.bed', col.names = c('chromosome', 'pos', 'value'))
file22 <- fread('../DepthBeds/LS174.HSV1-Kos-X1000.Filtered.sorted.paired.depth.fixed.bed', col.names = c('chromosome', 'pos', 'value'))
file23 <- fread('../DepthBeds/LS175.HSV1-Kos-X1000.Filtered.sorted.paired.depth.fixed.bed', col.names = c('chromosome', 'pos', 'value'))
file24 <- fread('../DepthBeds/LS176.HSV1-Kos-X1000.Filtered.sorted.paired.depth.fixed.bed', col.names = c('chromosome', 'pos', 'value'))
...
### INPUT bioreps
pdf(file = "macro-INPUT-Bioreps.pdf", width = 10, height = 5)
...
dev.off()
### LONG bioreps
pdf(file = "macro-LONG-Bioreps.pdf", width = 10, height = 5)
...
dev.off()
### PELLET bioreps
pdf(file = "macro-PELLET-Bioreps.pdf", width = 10, height = 5)
...
dev.off()
### SHORT bioreps
pdf(file = "macro-SHORT-Bioreps.pdf", width = 10, height = 5)
...
### GENERATE FINAL PLOT
pdf(file = "macro-Digestion-Biorep1.pdf", width = 10, height = 5)
...
pdf(file = "macro-Digestion-Biorep2.pdf", width = 10, height = 5)
...
pdf(file = "macro-Digestion-BothBioReps.pdf", width = 10, height = 5)
